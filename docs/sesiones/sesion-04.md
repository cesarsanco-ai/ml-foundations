# Sesión 04: Clasificación I - Regresión Logística y Balance de Datos

[⬅️ Volver al Índice](../index.md)

## 🎯 Objetivo de la Sesión

Construir, interpretar y evaluar modelos de clasificación binaria y multiclase utilizando regresión logística, incorporando técnicas de balanceo de datos (SMOTE, undersampling, class weights) y selección adecuada de métricas.
...
* 📝 **Quick Reference:** [Descargar CheatSheet](../material/Sesion04/cheatsheet/cheatsheet.md)
